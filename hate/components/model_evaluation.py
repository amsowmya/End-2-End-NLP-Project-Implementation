...
class ModelEvaluation:
    ...
    def get_best_model_from_gcloud(self) -> str:
        ...
        """
        try:
            logging.info("Entered the get_best_model_from_gcloud method of ModelEvaluation class")
    ...
    def evaluate(self):
        try:
            logging.info("Entering into the evaluation function of ModelEvaluation class")
            ...
            test_sequences_matrix = pad_sequences(test_sequences, MAX_LEN)
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifacts:
        try:
            ...
            if os.path.isfile(best_model_path) is False:
                ...
                logging.info("Load bes model fetched from gcloud storage")
