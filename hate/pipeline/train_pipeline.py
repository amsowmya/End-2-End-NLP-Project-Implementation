...
class TrainPipeline:
    ...
    def start_data_transformation(self, data_ingestion_artifacts: DataIngestionArtifacts) -> DataTransformationArtifacts:
        ...
        try:
            ...
            logging.info("Exited start_data_transformation method of TrainPipeline class")
    ...
    def start_model_evaluation(self, model_trainer_artifacts: ModelTrainerArtifacts, data_transformation_artifacts: DataTransformationArtifacts) -> ModelEvaluationArtifacts:
        logging.info("Entete the start_model_evaluation method of TrainPipeline class")
        try:
